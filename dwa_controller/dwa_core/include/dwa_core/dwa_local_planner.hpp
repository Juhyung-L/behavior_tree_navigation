...
public:
    ...
    /**
     * @param current_pose robot's current pose in local costmap frame
     * @param current_velocity robot's current velocity in robot frame
     * @param global_path global path generated by global path planner in global costmap frame
     */
