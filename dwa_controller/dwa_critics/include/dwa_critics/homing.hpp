...
/**
 * @class HomingCritic
 * @brief If the goal pose is inside the local costmap, score local paths 
 * based on distance between goal pose and last pose of local path
*/
class HomingCritic : public BaseCritic
{
public:
    HomingCritic();
    void prepare(const nav_2d_msgs::msg::Path2D& globa_path, const geometry_msgs::msg::Pose2D& goal_pose) override;
